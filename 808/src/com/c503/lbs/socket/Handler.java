    			...
    			while(true){
	                ...
	                while(-1 != length){
	                      ...
	                      if(fBase.getm_FrameHead().getID() == FrameType.MSG_WZXXHB){
	    			        	  ...
	    			        	  //传输过来的经纬度反了
	    			        	  car.setLatitude(String.valueOf(fa.getM_dlongitude()));
	    			        	  car.setLongitude(String.valueOf(fa.getM_dlatitude()));
	    			        	  ...
	    			        	  //传输过来的经纬度反了
	    			        	  restCar.setLatitude(String.valueOf(fa.getM_dlongitude()));
	    			        	  restCar.setLongitude(String.valueOf(fa.getM_dlatitude()));
